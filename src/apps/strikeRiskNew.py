...
greeksDropdown = dcc.Dropdown(
    ...
    options=[
        ...
        {"label": "Full Gamma", "value": "total_skew_gammas"},
        {"label": "Gamma Breakeven", "value": "total_gammaBreakEven"},
        {"label": "Theta", "value": "total_thetas"},
        {"label": "Vega", "value": "total_vegas"},
        {"label": "Skew Sensitivity", "value": "total_skew_sensitivity"},
        {"label": "Call Sensitivity", "value": "total_call_sensitivity"},
        {"label": "Put Sensitivity", "value": "total_put_sensitivity"},
