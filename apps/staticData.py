    ...
    [
        dbc.FormGroup(
            [
                ...
                dbc.Input(type="text", id= 'product', placeholder="Georgia product"),
                                dbc.FormFeedback(
        ...
        dbc.FormGroup(
            ...
            [
                ...
                dbc.FormFeedback("That looks like a a first Wednesday", valid=True ),
                dbc.FormFeedback("This does not look like a first Wednesday", valid=False ),
                dbc.Label("third_wed", className="mr-2"),
                dbc.Input(id= "third_wed",type="date"),                
                dbc.FormFeedback("That looks like a a third Wednesday", valid=True),
                dbc.FormFeedback( "This does not look like a third Wednesday", valid=False ),
       ...
       dbc.Row([
           dbc.Col([
                ...
                dbc.Label('Input fields', id = "update")
                   ...
                   dbc.Col([
                        dbc.Button("Delete",id='delButton', color="danger", active=False, className="mr-1"),
...
@app.callback(
    [Output("expiry", "valid"), Output("expiry", "invalid"), Output("third_wed", "valid"), Output("third_wed", "invalid")],
    ...
    if expiry:
        ...
        if thirdWed:
            ...
            if thirdWed==third:
                ...
                thirdWed = [False, True]
        else: thirdWed = [no_update, no_update]
...
inputs = ["product", "name", "underlying",  "strike_max", "strike_min", "strike_step", "expiry", "multiplier", "currency",
 ...
 "option_type", "vol_underlying", "ffd", "day_count", "day_count", "lme_short_name", "vol_model_type", "exchange"]
