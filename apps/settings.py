...
inputs = html.Div([
    ...
    html.Div([
            ...
            html.Div([dcc.Input(id='volEdge',  type='text')], className ='two columns'),
            html.Div(id= 'CvolEdge', className ='two columns')
        ],className = 'row'),
    html.Div([
            html.Div('Bid Asym', className ='two columns' ),
            html.Div([dcc.Input(id='volBidAsym',  type='text')], className ='two columns'),
            html.Div(id= 'CvolBidAsym', className ='two columns'),
        ],className = 'row'),
    html.Div([
            html.Div('Ask Asym', className ='two columns' ),
            html.Div([dcc.Input(id='volAskAsym',  type='text')], className ='two columns'),
            html.Div(id= 'CvolAskAsym', className ='two columns'),
        ],className = 'row'),
    html.H2('Skew', className = 'row'),
    html.Div([
            html.Div('Edge Multiplier', className ='two columns' ),
            html.Div([dcc.Input(id='skewEdge',  type='text')], className ='two columns'),
            html.Div(id= 'CskewEdge', className ='two columns')
        ],className = 'row'),
    html.Div([
            html.Div('Bid Asym', className ='two columns' ),
            html.Div([dcc.Input(id='skewBidAsym',  type='text')], className ='two columns'),
            html.Div(id= 'CskewBidAsym', className ='two columns'),
        ],className = 'row'),
    html.Div([
            html.Div('Ask Asym', className ='two columns' ),
            html.Div([dcc.Input(id='skewAskAsym',  type='text')], className ='two columns'),
            html.Div(id= 'CskewAskAsym', className ='two columns'),
        ],className = 'row'),
    html.H2('Call', className = 'row'),
    html.Div([
            html.Div('Edge Multiplier', className ='two columns' ),
            html.Div([dcc.Input(id='callEdge',  type='text')], className ='two columns'),
            html.Div(id= 'CcallEdge', className ='two columns')
        ],className = 'row'),
    html.Div([
            html.Div('Bid Asym', className ='two columns' ),
            html.Div([dcc.Input(id='callBidAsym',  type='text')], className ='two columns'),
            html.Div(id= 'CcallBidAsym', className ='two columns'),
        ],className = 'row'),
    html.Div([
            html.Div('Ask Asym', className ='two columns' ),
            html.Div([dcc.Input(id='callAskAsym',  type='text')], className ='two columns'),
            html.Div(id= 'CcallAskAsym', className ='two columns'),
        ],className = 'row'),
    html.H2('Put', className = 'row'),
    html.Div([
            html.Div('Edge Multiplier', className ='two columns' ),
            html.Div([dcc.Input(id='putEdge',  type='text')], className ='two columns'),
            html.Div(id= 'CputEdge', className ='two columns')
        ],className = 'row'),
    html.Div([
            html.Div('Bid Asym', className ='two columns' ),
            html.Div([dcc.Input(id='putBidAsym',  type='text')], className ='two columns'),
            html.Div(id= 'CputBidAsym', className ='two columns'),
        ],className = 'row'),
    html.Div([
            html.Div('Ask Asym', className ='two columns' ),
            html.Div([dcc.Input(id='putAskAsym',  type='text')], className ='two columns'),
...
@app.callback(
    ...
    state =[State(component_id='size', component_property='value'),
...
def submitVols(n_clicks, size, product, volEdge, skewEdge, callEdge, putEdge, Csize, CvolEdge, CskewEdge, CcallEdge, CputEdge,
              volAskAsym, skewAskAsym, callAskAsym, putAskAsym, CvolAskAsym, CskewAskAsym, CcallAskAsym, CputAskAsym,
              volBidAsym, skewBidAsym, callBidAsym, putBidAsym, CvolBidAsym, CskewBidAsym, CcallBidAsym, CputBidAsym,
              ):
     ...
     settings = {'savedDate': str(dt.datetime.now()) ,'size': size,
                  'volEdge':volEdge,'skewEdge':skewEdge, 'callEdge':callEdge, 'putEdge':putEdge,
                  'volAskAsym': volAskAsym, 'skewAskAsym':skewAskAsym, 'callAskAsym': callAskAsym, 'putAskAsym': putAskAsym,
                   'volBidAsym':volBidAsym,'skewBidAsym':skewBidAsym, 'callBidAsym':callBidAsym, 'putBidAsym':putBidAsym,
                  }
     if n_clicks != None:       
        sumbiSettings(product.lower(), settings)

@app.callback(  Output('hidden-divSettings1', 'children'), 
...
for param in ('Csize', 'CvolEdge', 'CskewEdge', 'CcallEdge', 'CputEdge', 'CvolAskAsym', 'CskewAskAsym',
              'CputAskAsym', 'CcallAskAsym', 'CvolBidAsym', 'CskewBidAsym',
              'CputBidAsym', 'CcallBidAsym'):
...
for param in ('size', 'volEdge', 'skewEdge', 'callEdge', 'putEdge', 'volAskAsym', 'skewAskAsym',
              'putAskAsym', 'callAskAsym', 'volBidAsym', 'skewBidAsym',
              'putBidAsym', 'callBidAsym'):
