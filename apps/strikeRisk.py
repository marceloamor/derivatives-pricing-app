...
layout = html.Div([
    topMenu('Strike Risk'),
    dbc.Row([
        dbc.Col([dcc.Dropdown(id='strike-portfolio-selector', value='copper', options =  onLoadPortFolio())], width = 3),
        dbc.Col([dcc.Dropdown(id='strike-risk-selector', value='quanitity', options =  [
        ...
        dbc.Col([dcc.Dropdown(id='relAbs', value='strike', options =   [
